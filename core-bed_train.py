...
for tissue in tissue_array:
	...
	if tissue == "user_provided_files":
		...
		if args.ref_genome == "hg19" or args.ref_genome == "grch37":
			...
			bed_4me1 = pybedtools.BedTool(args.ref_dir + "/" + tissue + "_4me1_" + "hg38.bed.gz")
			bed_4me3 = pybedtools.BedTool(args.ref_dir + "/" + tissue + "_4me3_" + "hg38.bed.gz")
			bed_27ac = pybedtools.BedTool(args.ref_dir + "/" + tissue + "_27ac_" + "hg38.bed.gz")
			bed_27me3 = pybedtools.BedTool(args.ref_dir + "/" + tissue + "_27me3_" + "hg38.bed.gz")
			#bed_36me3 = pybedtools.BedTool(args.ref_dir + "/" + tissue + "_36me3_" + "hg38.bed.gz")
			bed_ctcf = pybedtools.BedTool(args.ref_dir + "/" + tissue + "_CTCF_" + "hg38.bed.gz")
			bed_dnase = pybedtools.BedTool(args.ref_dir + "/" + tissue + "_DNase-seq_" + "hg38.bed.gz")
