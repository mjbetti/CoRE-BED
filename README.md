...
## Cite CoRE-BED 
Betti, M.J., Aldrich, M.C., & Gamazon, E.R. (2022). *Maximum-entropy integrative epigenomic framework reveals regulatory mechanisms at human disease loci*. Preprint.  
...
## Data availability
Peak calls for H3K4me1, H3K4me3, H3K27ac, H3K27me3, DNase-seq, and CTCF ChIP-seq across 827 EpiMap biosamples can be downloaded from 10.5281/zenodo.6599920. These serve as the reference epigenomes for running CoRE-BED-training prediction.

Included in this dataset are CoRE-BED promoter and enhancer predictions across all 827 CoRE-BED-training and 28 CoRE-BED-test biosamples.
...
* ```Other```: other_breast_epithelium_51f, other_breast_epithelium_53f, other_epidermal_melanocyte, other_foreskin_melanocyte_newborn_m, other_limb_embryo_53_days_56_days, other_limb_embryo_58_days_59_days, other_mammary_stem_cell
...
usage: core-bed_test.py [-h] -i INPUT [-s SEPARATOR] -g REF_GENOME -t TISSUE
                        [-ud TSS_DISTANCE_UPSTREAM]
                        [-dd TSS_DISTANCE_DOWNSTREAM] [-o OUTPUT] [-r REF_DIR]
                        [--no_multianno] [--write_summary] [--write_anno_only]
...
optional arguments:
  ...
  -h3k4me1, --only_h3k4me1
                        ...
                        tissue
  -h3k4me3, --only_h3k4me3
                        Instead of full CoRE-BED regulatory annotations, only
                        evaluate input for H3K4me3 overlap in the target
                        tissue
  -h3k27ac, --only_h3k27ac
                        Instead of full CoRE-BED regulatory annotations, only
                        evaluate input for H3K27ac overlap in the target
                        tissue
  -h3k27me3, --only_h3k27me3
                        Instead of full CoRE-BED regulatory annotations, only
                        evaluate input for H3K27me3 overlap in the target
                        tissue
  -dhs, --only_dhs      Instead of full CoRE-BED regulatory annotations, only
...
for tissue in ${tissue_array[@]}; do
	...
	-g hg19 \
	-t $tissue \
	-o phecode-401-both_sexes.func_anno.$tissue\.5000_1000.tsv  \
	-v \
	--no_multianno \
	--bed_cols 1,2,2 \
	--input_header"
