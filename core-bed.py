###Developed by Michael J Betti, April 2021, updated 28 August 2021
...
if args.ref_genome.lower() == "hg38" or args.ref_genome.lower() == "grch38":
	...
	for tissue in tissue_array:
		...
		if tissue == "adipose":
			...
			if not os.path.exists("ref_files/adipose_ctcf_hg38.bed.gz"):
				download_ref("https://www.encodeproject.org/files/ENCFF464DDN/@@download/ENCFF464DDN.bed.gz", "adipose_ctcf_hg38.bed.gz")
			if not os.path.exists("ref_files/adipose_dnase_hg38.bed.gz"):
		...
		#Cultured fibroblast (Homo sapiens IMR-90)
			...
			if not os.path.exists("ref_files/cultured_fibroblast_4me1_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/cultured_fibroblast_4me3_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/cultured_fibroblast_27ac_hg38.bed.gz"):
			...
			#if not os.path.exists("ref_files/cultured_fibroblast_36me3_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/cultured_fibroblast_ctcf_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/cultured_fibroblast_dnase_hg38.bed.gz"):
		...
		#EBV-transformed lymphocyte (Homo sapiens GM12878)
			...
			if not os.path.exists("ref_files/ebv_transformed_lymphocyte_4me1_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/ebv_transformed_lymphocyte_4me3_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/ebv_transformed_lymphocyte_27ac_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/ebv_transformed_lymphocyte_27me3_hg38.bed.gz"):
			...
			#if not os.path.exists("ref_files/ebv_transformed_lymphocyte_36me3_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/ebv_transformed_lymphocyte_ctcf_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/ebv_transformed_lymphocyte_dnase_hg38.bed.gz"):
		...
		#Esophagus muscularis mucosa (Homo sapiens esophagus muscularis mucosa tissue female adult (51 years) and Homo sapiens esophagus muscularis mucosa tissue male adult (37 years) (DNase-seq only))
			...
			if not os.path.exists("ref_files/esophagus_muscularis_mucosa_4me1_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_muscularis_mucosa_4me3_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_muscularis_mucosa_27ac_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_muscularis_mucosa_27me3_hg38.bed.gz"):
			...
			#if not os.path.exists("ref_files/esophagus_muscularis_mucosa_36me3_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_muscularis_mucosa_ctcf_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_muscularis_mucosa_dnase_hg38.bed.gz"):
		...
		#Esophagus squamous epithelium (Homo sapiens esophagus squamous epithelium tissue female adult (51 years) and Homo sapiens esophagus squamous epithelium tissue male adult (37 years) (DNase-seq only))
			...
			if not os.path.exists("ref_files/esophagus_squamous_epithelium_4me1_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_squamous_epithelium_4me3_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_squamous_epithelium_27ac_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_squamous_epithelium_27me3_hg38.bed.gz"):
			...
			#if not os.path.exists("ref_files/esophagus_squamous_epithelium_36me3_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_squamous_epithelium_ctcf_hg38.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_squamous_epithelium_dnase_hg38.bed.gz"):
		...
		#Intestine (Homo sapiens sigmoid colon tissue male adult (37 years) and Homo sapiens sigmoid colon tissue female adult (53 years) (DNase-seq only))
			...
			if not os.path.exists("ref_files/intestine_ctcf_hg38.bed.gz"):
				download_ref("https://www.encodeproject.org/files/ENCFF480QYI/@@download/ENCFF480QYI.bed.gz", "intestine_ctcf_hg38.bed.gz")
			if not os.path.exists("ref_files/intestine_dnase_hg38.bed.gz"):
...
if args.ref_genome.lower() == "hg19" or args.ref_genome.lower() == "grch37":
	...
	for tissue in tissue_array:
		...
		#Cultured fibroblast (Homo sapiens IMR-90)
			...
			if not os.path.exists("ref_files/cultured_fibroblast_4me3_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/cultured_fibroblast_27ac_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/cultured_fibroblast_27me3_hg19.bed.gz"):
			...
			#if not os.path.exists("ref_files/cultured_fibroblast_36me3_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/cultured_fibroblast_ctcf_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/cultured_fibroblast_dnase_hg19.bed.gz"):
		...
		#EBV-transformed lymphocyte (Homo sapiens GM12878)
			...
			if not os.path.exists("ref_files/ebv_transformed_lymphocyte_4me1_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/ebv_transformed_lymphocyte_4me3_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/ebv_transformed_lymphocyte_27ac_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/ebv_transformed_lymphocyte_27me3_hg19.bed.gz"):
			...
			#if not os.path.exists("ref_files/ebv_transformed_lymphocyte_36me3_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/ebv_transformed_lymphocyte_ctcf_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/ebv_transformed_lymphocyte_dnase_hg19.bed.gz"):
		...
		#Esophagus muscularis mucosa (Homo sapiens esophagus muscularis mucosa tissue female adult (51 years) and Homo sapiens esophagus muscularis mucosa tissue male adult (37 years) (DNase-seq only))
			...
			if not os.path.exists("ref_files/esophagus_muscularis_mucosa_4me3_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_muscularis_mucosa_27ac_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_muscularis_mucosa_27me3_hg19.bed.gz"):
			...
			#if not os.path.exists("ref_files/esophagus_muscularis_mucosa_36me3_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_muscularis_mucosa_ctcf_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_muscularis_mucosa_dnase_hg19.bed.gz"):
		...
		#Esophagus squamous epithelium (Homo sapiens esophagus squamous epithelium tissue female adult (51 years) and Homo sapiens esophagus squamous epithelium tissue male adult (37 years) (DNase-seq only))
			...
			if not os.path.exists("ref_files/esophagus_squamous_epithelium_4me1_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_squamous_epithelium_4me3_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_squamous_epithelium_27ac_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_squamous_epithelium_27me3_hg19.bed.gz"):
			...
			#if not os.path.exists("ref_files/esophagus_squamous_epithelium_36me3_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_squamous_epithelium_ctcf_hg19.bed.gz"):
			...
			if not os.path.exists("ref_files/esophagus_squamous_epithelium_dnase_hg19.bed.gz"):
...
for tissue in tissue_array:
	...
	if tissue == "user_provided_files":
		...
		bed_4me1 = pybedtools.BedTool("ref_files/" + user_tissue_names_array[user_files_index] + "_4me1_" + bed_ref + ".bed.gz")
		bed_4me3 = pybedtools.BedTool("ref_files/" + user_tissue_names_array[user_files_index] + "_4me3_" + bed_ref + ".bed.gz")
		bed_27ac = pybedtools.BedTool("ref_files/" + user_tissue_names_array[user_files_index] + "_27ac_" + bed_ref + ".bed.gz")
		bed_27me3 = pybedtools.BedTool("ref_files/" + user_tissue_names_array[user_files_index] + "_27me3_" + bed_ref + ".bed.gz")
		#bed_36me3 = pybedtools.BedTool("ref_files/" + user_tissue_names_array[user_files_index] + "_36me3_" + bed_ref + ".bed.gz")
		bed_ctcf = pybedtools.BedTool("ref_files/" + user_tissue_names_array[user_files_index] + "_ctcf_" + bed_ref + ".bed.gz")
		bed_dnase = pybedtools.BedTool("ref_files/" + user_tissue_names_array[user_files_index] + "_dnase_" + bed_ref + ".bed.gz")
	else:
		...
		#bed_36me3 = pybedtools.BedTool("ref_files/" + tissue + "_36me3_" + bed_ref + ".bed.gz")
		bed_ctcf = pybedtools.BedTool("ref_files/" + tissue + "_ctcf_" + bed_ref + ".bed.gz")
