...
def download_ref(epimap_accession, out_name):
	...
	if not os.path.exists(args.ref_dir + "/" + out_name + "_ATAC-seq_hg19" + ".bed.gz"):
		...
		if os.path.exists(args.ref_dir + "/" + out_name + "_ATAC-seq_hg19_observed" + ".bigWig") and os.path.exists(args.ref_dir + "/" + out_name + "_ATAC-seq_hg19_imputed" + ".bigWig"):
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_ATAC-seq_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_ATAC-seq_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_ATAC-seq_hg19" + ".bigWig"))
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_ATAC-seq_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_ATAC-seq_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_ATAC-seq_hg19" + ".bigWig"))
		subprocess.run(["macs2", "bdgpeakcall", "-i", os.path.join(args.ref_dir, out_name + "_ATAC-seq_hg19" + ".bedGraph"), "-o", os.path.join(args.ref_dir, out_name + "_ATAC-seq_hg19" + ".bed")])
		subprocess.run(["bgzip", os.path.join(args.ref_dir, out_name + "_ATAC-seq_hg19" + ".bed")])
		os.remove(os.path.join(args.ref_dir, out_name + "_ATAC-seq_hg19" + ".bedGraph"))
	#EP300
	if not os.path.exists(args.ref_dir + "/" + out_name + "_EP300_hg19" + ".bed.gz"):
		...
		#Observed
		response_observed = requests.get("https://epigenome.wustl.edu/epimap/data/observed/FINAL_EP300_" + epimap_accession + ".sub_VS_FINAL_WCE_BSS00007.pval.signal.bedgraph.gz.bigWig", allow_redirects = True)
		if response_observed.status_code == 200:
		...
		if os.path.exists(args.ref_dir + "/" + out_name + "_EP300_hg19_observed" + ".bigWig") and os.path.exists(args.ref_dir + "/" + out_name + "_EP300_hg19_imputed" + ".bigWig"):
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_EP300_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_EP300_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_EP300_hg19" + ".bigWig"))
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_EP300_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_EP300_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_EP300_hg19" + ".bigWig"))
		subprocess.run(["macs2", "bdgpeakcall", "-i", os.path.join(args.ref_dir, out_name + "_EP300_hg19" + ".bedGraph"), "-o", os.path.join(args.ref_dir, out_name + "_EP300_hg19" + ".bed")])
		subprocess.run(["bgzip", os.path.join(args.ref_dir, out_name + "_EP300_hg19" + ".bed")])
		os.remove(os.path.join(args.ref_dir, out_name + "_EP300_hg19" + ".bedGraph"))
	#H2AFZ
	if not os.path.exists(args.ref_dir + "/" + out_name + "_H2AFZ_hg19" + ".bed.gz"):
		...
		#Observed
		response_observed = requests.get("https://epigenome.wustl.edu/epimap/data/observed/FINAL_H2AFZ_" + epimap_accession + ".sub_VS_FINAL_WCE_" + epimap_accession + ".pval.signal.bedgraph.gz.bigWig", allow_redirects = True)
		if response_observed.status_code == 200:
		...
		if os.path.exists(args.ref_dir + "/" + out_name + "_H2AFZ_hg19_observed" + ".bigWig") and os.path.exists(args.ref_dir + "/" + out_name + "_H2AFZ_hg19_imputed" + ".bigWig"):
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_H2AFZ_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_H2AFZ_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_H2AFZ_hg19" + ".bigWig"))
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_H2AFZ_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_H2AFZ_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_H2AFZ_hg19" + ".bigWig"))
		subprocess.run(["macs2", "bdgpeakcall", "-i", os.path.join(args.ref_dir, out_name + "_H2AFZ_hg19" + ".bedGraph"), "-o", os.path.join(args.ref_dir, out_name + "_H2AFZ_hg19" + ".bed")])
		subprocess.run(["bgzip", os.path.join(args.ref_dir, out_name + "_H2AFZ_hg19" + ".bed")])
		os.remove(os.path.join(args.ref_dir, out_name + "_H2AFZ_hg19" + ".bedGraph"))
	#H3K4me1
	...
	if not os.path.exists(args.ref_dir + "/" + out_name + "_H3K4me2_hg19" + ".bed.gz"):
		...
		#Observed
		response_observed = requests.get("https://epigenome.wustl.edu/epimap/data/observed/FINAL_H3K4me2_" + epimap_accession + ".sub_VS_FINAL_WCE_" + epimap_accession + ".pval.signal.bedgraph.gz.bigWig", allow_redirects = True)
		if response_observed.status_code == 200:
		...
		if os.path.exists(args.ref_dir + "/" + out_name + "_H3K4me2_hg19_observed" + ".bigWig") and os.path.exists(args.ref_dir + "/" + out_name + "_H3K4me2_hg19_imputed" + ".bigWig"):
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_H3K4me2_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_H3K4me2_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_H3K4me2_hg19" + ".bigWig"))
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_H3K4me2_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_H3K4me2_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_H3K4me2_hg19" + ".bigWig"))
		subprocess.run(["macs2", "bdgpeakcall", "-i", os.path.join(args.ref_dir, out_name + "_H3K4me2_hg19" + ".bedGraph"), "-o", os.path.join(args.ref_dir, out_name + "_H3K4me2_hg19" + ".bed")])
		subprocess.run(["bgzip", os.path.join(args.ref_dir, out_name + "_H3K4me2_hg19" + ".bed")])
		os.remove(os.path.join(args.ref_dir, out_name + "_H3K4me2_hg19" + ".bedGraph"))	
	#H3K4me3
	...
	if not os.path.exists(args.ref_dir + "/" + out_name + "_H3K9ac_hg19" + ".bed.gz"):
		...
		#Observed
		response_observed = requests.get("https://epigenome.wustl.edu/epimap/data/observed/FINAL_H3K9ac_" + epimap_accession + ".sub_VS_FINAL_WCE_" + epimap_accession + ".pval.signal.bedgraph.gz.bigWig", allow_redirects = True)
		if response_observed.status_code == 200:
		...
		if os.path.exists(args.ref_dir + "/" + out_name + "_H3K9ac_hg19_observed" + ".bigWig") and os.path.exists(args.ref_dir + "/" + out_name + "_H3K9ac_hg19_imputed" + ".bigWig"):
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_H3K9ac_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_H3K9ac_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_H3K9ac_hg19" + ".bigWig"))
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_H3K9ac_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_H3K9ac_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_H3K9ac_hg19" + ".bigWig"))
		subprocess.run(["macs2", "bdgpeakcall", "-i", os.path.join(args.ref_dir, out_name + "_H3K9ac_hg19" + ".bedGraph"), "-o", os.path.join(args.ref_dir, out_name + "_H3K9ac_hg19" + ".bed")])
		subprocess.run(["bgzip", os.path.join(args.ref_dir, out_name + "_H3K9ac_hg19" + ".bed")])
		os.remove(os.path.join(args.ref_dir, out_name + "_H3K9ac_hg19" + ".bedGraph"))
	#H3K9me3
	if not os.path.exists(args.ref_dir + "/" + out_name + "_H3K9me3_hg19" + ".bed.gz"):
		...
		#Observed
		response_observed = requests.get("https://epigenome.wustl.edu/epimap/data/observed/FINAL_H3K9me3_" + epimap_accession + ".sub_VS_FINAL_WCE_" + epimap_accession + ".pval.signal.bedgraph.gz.bigWig", allow_redirects = True)
		if response_observed.status_code == 200:
		...
		if os.path.exists(args.ref_dir + "/" + out_name + "_H3K9me3_hg19_observed" + ".bigWig") and os.path.exists(args.ref_dir + "/" + out_name + "_H3K9me3_hg19_imputed" + ".bigWig"):
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_H3K9me3_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_H3K9me3_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_H3K9me3_hg19" + ".bigWig"))
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_H3K9me3_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_H3K9me3_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_H3K9me3_hg19" + ".bigWig"))
		subprocess.run(["macs2", "bdgpeakcall", "-i", os.path.join(args.ref_dir, out_name + "_H3K9me3_hg19" + ".bedGraph"), "-o", os.path.join(args.ref_dir, out_name + "_H3K9me3_hg19" + ".bed")])
		subprocess.run(["bgzip", os.path.join(args.ref_dir, out_name + "_H3K9me3_hg19" + ".bed")])
		os.remove(os.path.join(args.ref_dir, out_name + "_H3K9me3_hg19" + ".bedGraph"))				
	#H3K27ac
	...
	if not os.path.exists(args.ref_dir + "/" + out_name + "_H3K36me3_hg19" + ".bed.gz"):
		...
		#Observed
		response_observed = requests.get("https://epigenome.wustl.edu/epimap/data/observed/FINAL_H3K36me3_" + epimap_accession + ".sub_VS_FINAL_WCE_" + epimap_accession + ".pval.signal.bedgraph.gz.bigWig", allow_redirects = True)
		if response_observed.status_code == 200:
		...
		if os.path.exists(args.ref_dir + "/" + out_name + "_H3K36me3_hg19_observed" + ".bigWig") and os.path.exists(args.ref_dir + "/" + out_name + "_H3K36me3_hg19_imputed" + ".bigWig"):
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_H3K36me3_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_H3K36me3_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_H3K36me3_hg19" + ".bigWig"))
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_H3K36me3_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_H3K36me3_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_H3K36me3_hg19" + ".bigWig"))
		subprocess.run(["macs2", "bdgpeakcall", "-i", os.path.join(args.ref_dir, out_name + "_H3K36me3_hg19" + ".bedGraph"), "-o", os.path.join(args.ref_dir, out_name + "_H3K36me3_hg19" + ".bed")])
		subprocess.run(["bgzip", os.path.join(args.ref_dir, out_name + "_H3K36me3_hg19" + ".bed")])
		os.remove(os.path.join(args.ref_dir, out_name + "_H3K36me3_hg19" + ".bedGraph"))
	#H3K79me2
	if not os.path.exists(args.ref_dir + "/" + out_name + "_H3K79me2_hg19" + ".bed.gz"):
		...
		#Observed
		response_observed = requests.get("https://epigenome.wustl.edu/epimap/data/observed/FINAL_H3K79me2_" + epimap_accession + ".sub_VS_FINAL_WCE_" + epimap_accession + ".pval.signal.bedgraph.gz.bigWig", allow_redirects = True)
		if response_observed.status_code == 200:
		...
		if os.path.exists(args.ref_dir + "/" + out_name + "_H3K79me2_hg19_observed" + ".bigWig") and os.path.exists(args.ref_dir + "/" + out_name + "_H3K79me2_hg19_imputed" + ".bigWig"):
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_H3K79me2_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_H3K79me2_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_H3K79me2_hg19" + ".bigWig"))
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_H3K79me2_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_H3K79me2_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_H3K79me2_hg19" + ".bigWig"))
		subprocess.run(["macs2", "bdgpeakcall", "-i", os.path.join(args.ref_dir, out_name + "_H3K79me2_hg19" + ".bedGraph"), "-o", os.path.join(args.ref_dir, out_name + "_H3K79me2_hg19" + ".bed")])
		subprocess.run(["bgzip", os.path.join(args.ref_dir, out_name + "_H3K79me2_hg19" + ".bed")])
		os.remove(os.path.join(args.ref_dir, out_name + "_H3K79me2_hg19" + ".bedGraph"))
	#H4K20me1
	if not os.path.exists(args.ref_dir + "/" + out_name + "_H4K20me1_hg19" + ".bed.gz"):
		...
		#Observed
		response_observed = requests.get("https://epigenome.wustl.edu/epimap/data/observed/FINAL_H4K20me1_" + epimap_accession + ".sub_VS_FINAL_WCE_" + epimap_accession + ".pval.signal.bedgraph.gz.bigWig", allow_redirects = True)
		if response_observed.status_code == 200:
		...
		if os.path.exists(args.ref_dir + "/" + out_name + "_H4K20me1_hg19_observed" + ".bigWig") and os.path.exists(args.ref_dir + "/" + out_name + "_H4K20me1_hg19_imputed" + ".bigWig"):
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_H4K20me1_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_H4K20me1_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_H4K20me1_hg19" + ".bigWig"))
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_H4K20me1_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_H4K20me1_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_H4K20me1_hg19" + ".bigWig"))
		subprocess.run(["macs2", "bdgpeakcall", "-i", os.path.join(args.ref_dir, out_name + "_H4K20me1_hg19" + ".bedGraph"), "-o", os.path.join(args.ref_dir, out_name + "_H4K20me1_hg19" + ".bed")])
		subprocess.run(["bgzip", os.path.join(args.ref_dir, out_name + "_H4K20me1_hg19" + ".bed")])
		os.remove(os.path.join(args.ref_dir, out_name + "_H4K20me1_hg19" + ".bedGraph"))
	#POLR2A
	if not os.path.exists(args.ref_dir + "/" + out_name + "_POLR2A_hg19" + ".bed.gz"):
		if args.verbose:
			print("Downloading bigWig and compiling BED for " + out_name + " POLR2A...")
		#Observed
		response_observed = requests.get("https://epigenome.wustl.edu/epimap/data/observed/FINAL_POLR2A_" + epimap_accession + ".sub_VS_FINAL_WCE_" + epimap_accession + ".pval.signal.bedgraph.gz.bigWig", allow_redirects = True)
		if response_observed.status_code == 200:
			out_path_observed = os.path.join(args.ref_dir, out_name + "_POLR2A_hg19_observed" + ".bigWig")
			open(out_path_observed, 'wb').write(response_observed.content)
    	#Imputed
		response_imputed = requests.get("https://epigenome.wustl.edu/epimap/data/imputed/impute_" + epimap_accession + "_POLR2A.bigWig", allow_redirects = True)
		if response_imputed.status_code == 200:
			out_path_imputed = os.path.join(args.ref_dir, out_name + "_POLR2A_hg19_imputed" + ".bigWig")
			open(out_path_imputed, 'wb').write(response_imputed.content)
		#If both imputed and observed, merge files together into a bedGraph before peak calling. Otherwise, rename whatever invididual files have been donloaded and carry out the rest of the peak calling workflow
		if os.path.exists(args.ref_dir + "/" + out_name + "_POLR2A_hg19_observed" + ".bigWig") and os.path.exists(args.ref_dir + "/" + out_name + "_POLR2A_hg19_imputed" + ".bigWig"):
			subprocess.run(["bigWigMerge", os.path.join(args.ref_dir, out_name + "_POLR2A_hg19_observed" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_POLR2A_hg19_imputed" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_POLR2A_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_POLR2A_hg19_observed" + ".bigWig"))
			os.remove(os.path.join(args.ref_dir, out_name + "_POLR2A_hg19_imputed" + ".bigWig"))
		elif os.path.exists(args.ref_dir + "/" + out_name + "_POLR2A_hg19_observed" + ".bigWig") and not os.path.exists(args.ref_dir + "/" + out_name + "_POLR2A_hg19_imputed" + ".bigWig"):
			os.rename(args.ref_dir + "/" + out_name + "_POLR2A_hg19_observed" + ".bigWig", args.ref_dir + out_name + "_POLR2A_hg19" + ".bigWig")
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_POLR2A_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_POLR2A_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_POLR2A_hg19" + ".bigWig"))
		elif os.path.exists(args.ref_dir + "/" + out_name + "_POLR2A_hg19_imputed" + ".bigWig") and not os.path.exists(args.ref_dir + "/" + out_name + "_POLR2A_hg19_observed" + ".bigWig"):
			os.rename(args.ref_dir + "/" + out_name + "_POLR2A_hg19_imputed" + ".bigWig", args.ref_dir + "/" + out_name + "_POLR2A_hg19" + ".bigWig")
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_POLR2A_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_POLR2A_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_POLR2A_hg19" + ".bigWig"))
		subprocess.run(["macs2", "bdgpeakcall", "-i", os.path.join(args.ref_dir, out_name + "_POLR2A_hg19" + ".bedGraph"), "-o", os.path.join(args.ref_dir, out_name + "_POLR2A_hg19" + ".bed")])
		subprocess.run(["bgzip", os.path.join(args.ref_dir, out_name + "_POLR2A_hg19" + ".bed")])
		os.remove(os.path.join(args.ref_dir, out_name + "_POLR2A_hg19" + ".bedGraph"))
	#RAD21
	if not os.path.exists(args.ref_dir + "/" + out_name + "_RAD21_hg19" + ".bed.gz"):
		...
		#Observed
		response_observed = requests.get("https://epigenome.wustl.edu/epimap/data/observed/FINAL_RAD21_" + epimap_accession + ".sub_VS_FINAL_WCE_" + epimap_accession + ".pval.signal.bedgraph.gz.bigWig", allow_redirects = True)
		if response_observed.status_code == 200:
		...
		if os.path.exists(args.ref_dir + "/" + out_name + "_RAD21_hg19_observed" + ".bigWig") and os.path.exists(args.ref_dir + "/" + out_name + "_RAD21_hg19_imputed" + ".bigWig"):
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_RAD21_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_RAD21_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_RAD21_hg19" + ".bigWig"))
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_RAD21_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_RAD21_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_RAD21_hg19" + ".bigWig"))
		subprocess.run(["macs2", "bdgpeakcall", "-i", os.path.join(args.ref_dir, out_name + "_RAD21_hg19" + ".bedGraph"), "-o", os.path.join(args.ref_dir, out_name + "_RAD21_hg19" + ".bed")])
		subprocess.run(["bgzip", os.path.join(args.ref_dir, out_name + "_RAD21_hg19" + ".bed")])
		os.remove(os.path.join(args.ref_dir, out_name + "_RAD21_hg19" + ".bedGraph"))
	#SMC3
	if not os.path.exists(args.ref_dir + "/" + out_name + "_SMC3_hg19" + ".bed.gz"):
		...
		#Observed
		response_observed = requests.get("https://epigenome.wustl.edu/epimap/data/observed/FINAL_SMC3_" + epimap_accession + ".sub_VS_FINAL_WCE_" + epimap_accession + ".pval.signal.bedgraph.gz.bigWig", allow_redirects = True)
		if response_observed.status_code == 200:
		...
		if os.path.exists(args.ref_dir + "/" + out_name + "_SMC3_hg19_observed" + ".bigWig") and os.path.exists(args.ref_dir + "/" + out_name + "_SMC3_hg19_imputed" + ".bigWig"):
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_SMC3_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_SMC3_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_SMC3_hg19" + ".bigWig"))
			...
			subprocess.run(["bigWigToBedGraph", os.path.join(args.ref_dir, out_name + "_SMC3_hg19" + ".bigWig"), os.path.join(args.ref_dir, out_name + "_SMC3_hg19" + ".bedGraph")])
			os.remove(os.path.join(args.ref_dir, out_name + "_SMC3_hg19" + ".bigWig"))
		subprocess.run(["macs2", "bdgpeakcall", "-i", os.path.join(args.ref_dir, out_name + "_SMC3_hg19" + ".bedGraph"), "-o", os.path.join(args.ref_dir, out_name + "_SMC3_hg19" + ".bed")])
		subprocess.run(["bgzip", os.path.join(args.ref_dir, out_name + "_SMC3_hg19" + ".bed")])
		os.remove(os.path.join(args.ref_dir, out_name + "_SMC3_hg19" + ".bedGraph"))
