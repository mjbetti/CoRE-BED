...
file <- fread("all_28_tissues_all_associations_v1.0.reformat.case_control.recal.func_anno_5000_1000.txt", header = TRUE, sep = "\t", quote = "")
...
reg_df <- df[((rowSums(df[,35:62] == "active_promoter") > 0) | (rowSums(df[,35:62] == "bivalent_promoter") > 0) | (rowSums(df[,35:62] == "silenced_promoter") > 0) | (rowSums(df[,35:62] == "active_enhancer") > 0) | (rowSums(df[,35:62] == "poised_enhancer") > 0) | (rowSums(df[,35:62] == "primed_enhancer") > 0)),]
print("Number of variants with a functional (promoter/enhancer) annotation:")
print(nrow(reg_df))

#Comparing effect sizes
noreg_df <- df[!((rowSums(df[,35:62] == "active_promoter") > 0) | (rowSums(df[,35:62] == "bivalent_promoter") > 0) | (rowSums(df[,35:62] == "silenced_promoter") > 0) | (rowSums(df[,35:62] == "active_enhancer") > 0) | (rowSums(df[,35:62] == "poised_enhancer") > 0) | (rowSums(df[,35:62] == "primed_enhancer") > 0)),]
...
print("Mean odds ratio of promoter/enhancer variants:")
print(mean(effect_anno))
...
print("Mean odds ratio of variants without a functional annotation:")
print(mean(effect_noanno))
...
print("Mean p-value of promoter/enhancer variants:")
print(mean(p_anno))
...
print("Mean MAF of promoter/enhancer variants:")
print(mean(maf_anno))
...
print("Mean MAF of variants without a functional annotation:")
print(mean(maf_noanno))
