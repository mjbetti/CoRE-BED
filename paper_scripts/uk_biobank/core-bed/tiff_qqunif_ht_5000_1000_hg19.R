...
##European p-values
par(mar=c(1,1,1,1))
tiff("superimposed_qq_ht_5000_1000_eur_x8_y50.hg19.tiff", res = 300, width = 5, height = 5, units = 'in', compression = c( "lzw"))
...
par(mar=c(1,1,1,1))
tiff("superimposed_qq_ht_5000_1000_meta_x8_y50.hg19.tiff", res = 300, width = 5, height = 5, units = 'in', compression = c( "lzw"))
...
###European p-values
par(mar=c(1,1,1,1))
tiff("superimposed_qq_ht_5000_1000_eur_x5_y25.hg19.tiff", res = 300, width = 5, height = 5, units = 'in', compression = c( "lzw"))
...
##Meta analysis p-values
par(mar=c(1,1,1,1))
tiff("superimposed_qq_ht_5000_1000_meta_x5_y25.hg19.tiff", res = 300, width = 5, height = 5, units = 'in', compression = c( "lzw"))
...
###European p-values
par(mar=c(1,1,1,1))
tiff("superimposed_qq_ht_5000_1000_eur_x1.5_5_y25.hg19.tiff", res = 300, width = 5, height = 5, units = 'in', compression = c( "lzw"))
...
##Meta analysis p-values
par(mar=c(1,1,1,1))
tiff("superimposed_qq_ht_5000_1000_meta_x1.5_5_y25.hg19.tiff", res = 300, width = 5, height = 5, units = 'in', compression = c( "lzw"))
