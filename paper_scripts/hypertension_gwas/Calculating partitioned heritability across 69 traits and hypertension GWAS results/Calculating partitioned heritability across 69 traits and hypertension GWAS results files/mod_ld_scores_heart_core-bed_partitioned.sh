...
for chr in ${chr_array[@]}; do
    ...
    --wrap="python /home/bettimj/ldsc/ldsc.py \
			...
			--ld-wind-cm 1 \
			--annot /home/bettimj/gamazon_rotation/mod_core-bed/uk_biobank/h2/anno_1000G/hypertension/1000G.EUR.QC.$chr\.annot \
			--thin-annot \
			--out /home/bettimj/gamazon_rotation/mod_core-bed/uk_biobank/h2/anno_1000G/hypertension/1000G.EUR.QC.$chr \
