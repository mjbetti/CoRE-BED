...
for chr in ${chr_array[@]}; do
    ...
    --wrap="python /home/bettimj/ldsc/ldsc.py \
			...
			--ld-wind-cm 1 \
			--annot /home/bettimj/gamazon_rotation/core-bed_analysis/s2g_snps/h2/h2_att2/anno_1000G/chr$chr\/1000G.EUR.QC.$chr\.5000_1000.annot \
			--thin-annot \
			--out /home/bettimj/gamazon_rotation/core-bed_analysis/s2g_snps/h2/h2_att2/anno_1000G/core_bed_EUR.QC.$chr \
